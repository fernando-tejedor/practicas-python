from utilidades import validarFlotante,validarEntero,validarStr
    
codigo=validarEntero('ingrese su codigo, para finalizar digite 999  ')
while codigo !=999:

    nombre=validarStr('ingrese su nombre: ')
    ...
    print(f'la nota del estudiante {nombre} con codigo {codigo} es: {notaDefinitiva:,.2f}')
